// const MyCompain = () => {
//   return <div>this is my compain</div>;
// };

// export default MyCompain;
...
//     console.log(`Pause/Unpause donation with ID: ${id}`);
//     // Add pause/unpause functionality here
//   };

//   const handleEdit = (id) => {
//     console.log(`Redirect to edit page for donation ID: ${id}`);
//     // Redirect to edit page
//   };

//   const handleViewDonators = async (id) => {
//     console.log(`Fetching donators for donation ID: ${id}`);
//     // Replace with API to fetch donators
//     setSelectedDonators([
//       { name: "John Doe", amount: 20 },
//       { name: "Jane Smith", amount: 15 },
//     ]);
//     setShowModal(true);
//   };
