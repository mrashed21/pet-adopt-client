...
export default function Newsletter() {
  ...
  return (
    <div
      id="join-us"
      className="flex justify-center items-center bg-gray-100 pt-6 pb-10"
    >
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-4xl">
        ...
        <p className="text-center text-gray-600 mb-4">
          Stay updated with the latest news about pet adoptions, rescue stories,
          and how you can support us through donations. Join our mission to give
          every pet a loving home!
        </p>
