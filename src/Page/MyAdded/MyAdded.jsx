...
//     initialState: {
//       pagination: {
//         pageSize: 10, // Display a maximum of 10 pets per page
//       },
//     },
//   });
...
//             </table>
//           </div>
//           {pets.length > 10 && ( // Only show pagination if there are more than 10 pets
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        header: "Actions",
        cell: ({ row }) => {
          const isAdopted = row.original.adopted === true;
          const isPending = row.original.adopted === "pending";
          ...
          return (
            <div className="flex gap-2">
              ...
              <Button
                size="sm"
                className="px-4"
                color={isAdopted ? "gray" : isPending ? "yellow" : "green"}
                disabled={isAdopted || isPending || adoptMutation.isPending}
                onClick={() => handleAdopt(row.original._id)}
              >
                {isAdopted
                  ? "Adopted"
